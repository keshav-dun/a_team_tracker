...
const upsertEntrySchema = withTimeRangeRefinements(
  z.object({
    date: dateStr,
    status: statusOL,
...
const adminUpsertEntrySchema = withTimeRangeRefinements(
  z.object({
...
const bulkSetSchema = withTimeRangeRefinements(
  z.object({
...
const repeatPatternSchema = withTimeRangeRefinements(
  z.object({
    status: statusOLC,
